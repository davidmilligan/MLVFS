...
PT_STATIC_CONST( int, pfmMountFlagSystemVisible   , 0x00000002);
...
PT_STATIC_CONST( int, pfmMountFlagNoShellNotify   , 0x00008000);
...
PT_STATIC_CONST( int, pfmUnmountFlagForce     , 0x0002);
PT_STATIC_CONST( int, pfmUnmountFlagOnRelease , 0x0004);
...
PT_STATIC_CONST( PT_INT8, pfmAccessLevelOwner    , 6);
   // Deprecated names.
PT_STATIC_CONST( PT_INT8, pfmReadInfoAccess , 1);
PT_STATIC_CONST( PT_INT8, pfmReadDataAccess , 2);
PT_STATIC_CONST( PT_INT8, pfmWriteInfoAccess, 3);
PT_STATIC_CONST( PT_INT8, pfmDeleteAccess   , 4);
PT_STATIC_CONST( PT_INT8, pfmWriteDataAccess, 5);
PT_STATIC_CONST( PT_INT8, pfmOwnerAccess    , 6);
...
PT_STATIC_CONST( int, pfmLockFileFlagForWrite, 0x01);
