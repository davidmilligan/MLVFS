...
static struct image_buffer * get_or_create_image_buffer(const char * path, int(*new_buffer_cbr)(struct image_buffer *))
{
...
static void free_image_buffer_by_path(const char * path)
{
    RELOCK(image_buffer_mutex)
    {
